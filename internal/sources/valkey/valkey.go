...
// Source holds the config and, once made, the client. initValkeyClient takes
// no tracer, so unlike other sources there is no tracer field: ConnectOnce owns
...
// client returns the Valkey client, creating it on first use.
...
// ValkeyClient reports the client if one has been made. It is the type
