...
// GetClusterControllerClient reports the cluster client if one has been made;
// a deferred source has not connected yet.
...
// GetJobControllerClient reports the job client if one has been made; a
